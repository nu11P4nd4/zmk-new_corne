...
7. Download the firmware.zip file generated by Github Actions. This contains 4 files (1 for zmk studio, 1 for reseting the board, updated config for left half and right half)
8. Connect the left half of the keyboard to your PC using usb and put it in bootloader mode by double clicking the button next to the on/off switch. This will mount the device on your PC, then copy the left half uf2 file(nice_view_gem-eyelash_corne_left-zmk.uf2) to this drive and it will automatically unmount once finished
9. Do the same now with the right half of the keyboard and copy the nice_view_gem-eyelash_corne_right-zmk.uf2 file
10. This should load the new firmware on your system
